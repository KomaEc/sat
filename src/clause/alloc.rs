...
mod tests {
    ...
    fn test_allocate_clause() {
        ...
        let clause_ref1 = allocator.allocate_clause(
            &clause_data1[1..]
                .iter()
                .map(|lit| (*lit).into())
                .collect::<Vec<_>>()[..],
        );
        let clause_ref2 = allocator.allocate_clause(
            &clause_data2[1..]
                .iter()
                .map(|lit| (*lit).into())
                .collect::<Vec<_>>()[..],
        ...
        assert_eq!(
            allocator.get_clause(clause_ref1).lits(),
            &clause_data1[1..]
                .iter()
                .map(|lit| (*lit).into())
                .collect::<Vec<_>>()[..]
        ...
        assert_eq!(
            allocator.get_clause(clause_ref2).lits(),
            &clause_data2[1..]
                .iter()
                .map(|lit| (*lit).into())
                .collect::<Vec<_>>()[..]
